...
const Simulation = () => {
    ...
    const chartData = {
        ...
        distanceCovered: {
            ...
            datasets: [
                {
                    label: 'Distance Covered (billion km)',
        ...
        status: {
            ...
            datasets: [
                {
                    label: 'Status (Success=1, Failure=0)',
                    data: simulationData.map((yearData) => (yearData.fail ? 0 : 1)),
    ...
    return (
        <div style={{ backgroundColor: '#121212', color: '#FFFFFF', minHeight: '96vh', padding: '20px', backgroundImage:`url(${simulationData.length>0?bg2:bg})`}}>
            <div style={{display: 'flex', margin: '0 auto', height: '100%'}}>
                <div style={{padding: 20, width: '25vw', height: '90.5vh', backgroundColor: '#1e1e1e', borderRadius: 10}}>
                ...
                <div>
                    ...
                    <div style={{margin:5, padding: 15, backgroundColor: '#1e1e1e', borderRadius: 10}}>
                        ...
                        <h4 style={{margin:10}}>{formData['lightspeed_fraction']['value'] * 299792} km/hr</h4>
                    </div>
                    <div style={{margin:5, padding: 15, backgroundColor: '#1e1e1e', borderRadius: 10}}>
            ...
            {log}
                ...
                <div style={{width: '52vw', marginLeft: 10, color: '#E0E0E0'}}>
                    {simulationData.length > 0 && (<>
                        <h2 style={{marginTop: 10, color: '#FFFFFF', width:'100%', textAlign:'center'}}>SIMULATION RESULTS</h2>
                        <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, borderRadius: 10}}>
